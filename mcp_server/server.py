    ...
    tools = [
        ...
        Tool(
            ...
            description=(
                ...
                "search and list output carry 'dnr_soft_expired' and "
                "'dnr_age_days' on every do_not_revert decision — 180 "
                "days by default, override via "
                "CODEVIRA_DNR_SOFT_EXPIRE_DAYS (0 disables). The lock "
                "never auto-flips; the flag is advice. Call this on a "
                "soft-expired decision that is still load-bearing — it "
