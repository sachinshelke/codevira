...
# v2.2.0+: add list_resources + read_resource so handle_* coroutines
# stay coroutines after this module loads. Without this, downstream
# tests that import mcp_server.server later in the same pytest session
