...
from mcp_server.engine import (
    Policy, PolicyVerdict, register_policy, reset_policies,
)
...
class TestInjectSchemaConformance:
    ...
    def test_inject_payload_under_hookSpecificOutput(
    ...
    def test_inject_for_each_event_type_uses_correct_hookEventName(
        ...
        cases = [
            ...
            ("PostToolUse", {"tool_name": "Edit", "tool_input": {}, "tool_result": "ok"}),
...
class TestBlockSchemaConformance:
    ...
    def test_pretooluse_block_has_permissionDecision_deny(
        self, tmp_path, monkeypatch
    ):
